    ...
    render() {
        return (
            <Stack justifyContent={'center'} alignItems={'center'} height={'100vh'} width={'100vw'} maxWidth={'100%'} b>
                <Stack height={'88vh'} width={'70vw'} spacing={7} border={'1px solid #e7eaed'} boxShadow={2} borderRadius={1}>
                    <Stack>
                    ...
                    <Stack position={'relative'} left={'110px'} direction={'column'} spacing={4}>
                        ...
                        <Stack width={'70%'} direction={'row'} spacing={4}>
                            <TextField id="outlined-search" label="Address" type="search" size={'small'}
                                       sx={{width: '600px'}}/>
                            <TextField id="outlined-search" label="Salary" type="search" size={'small'}
                                       sx={{width: '200px'}}/>
                        </Stack>
                        ...
                        <Stack width={'70%'} direction={'row'} spacing={0} justifyContent={'end'}>
                            <Button sx={{textTransform: "none"}} size={'small'} variant={'contained'} title={this.state.text.toLowerCase()}>{'sign up'}</Button>
                        </Stack>
                    </Stack>
                </Stack>
